...
ROW_LABELS = {
    "put_lat_small": "RMA Put lat. (small)",
    "get_lat_small": "RMA Get lat. (small)",
    "put_lat_large": "RMA Put lat. (large)",
    "get_lat_large": "RMA Get lat. (large)",
    "put_bw_large": "RMA Put bandwidth",
    "get_bw_large": "RMA Get bandwidth",
    "allgather_flat": "Allgather (flat, 16p)",
    "alltoall_flat": "Alltoall (flat, 16p)",
    "allreduce_ctrl": "Allreduce (passthrough)",
    "stencil_9p": "Stencil RMA (9p)",
    "stencil_16p": "Stencil RMA (16p)",
    "stencil_25p": "Stencil RMA (25p)",
    "stencil_36p": "Stencil RMA (36p)",
