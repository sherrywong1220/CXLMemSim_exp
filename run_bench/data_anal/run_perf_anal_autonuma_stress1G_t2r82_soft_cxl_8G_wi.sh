...
export DATA_ANAL_BENCHMARKS="pr-twitter-2c bc-twitter-2c bfs-twitter-2c cc-twitter-2c NPB-BT.D NPB-CG.D NPB-FT.C NPB-LU.D NPB-MG.D NPB-SP.D silo_ycsb"
export DATA_ANAL_TIERING_VERS="autonuma_tiering_thp autonuma_tiering_thp_512K"
export DATA_ANAL_MEM_POLICYS="cpu0.weightedinterleave0_2.14 cpu0.weightedinterleave0_2"
export DATA_ANAL_LDRAM_SIZES="stress1G_t2r82_soft_cxl_8G"
export CSV_FILE="perf_results_autonuma_stress1G_t2r82_soft_cxl_8G_wi.csv"
