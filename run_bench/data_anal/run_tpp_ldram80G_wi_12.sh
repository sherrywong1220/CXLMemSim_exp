...
export DATA_ANAL_TIERING_VERS="tpp nobalance tpp_thp nobalance_thp tpp_thp_512K  tpp_thp_64K"
export DATA_ANAL_MEM_POLICYS="cpu0.weightedinterleave0_2.12"
export DATA_ANAL_LDRAM_SIZES="80G"
export CSV_FILE="tpp_perf_results_ldram80G_wi_12.csv"
