...
# Generate run script for LULESH CXL on 4 nodes (perfect cube process counts).

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

BENCH_NAME="lulesh_cxl"
USE_CASE_BASE="lulesh_cxl_mpi_cxl_node4_20260405"
NET_CONFIG="mpi_cxl"
NUM_NODES="4"
PROCESS_LIST="8 27 64"
