...
# Generate run script for LULESH baseline s=80 on 1 node qemuless.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

BENCH_NAME="lulesh_baseline_s80"
USE_CASE_BASE="lulesh_baseline_s80_mpi_cxl_qemuless_node1_20260407"
# Match the cxl s80 config so the comparison is strictly "DRAM vs CXL DAX
