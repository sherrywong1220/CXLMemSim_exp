...
def plot_comparison(data):
    ...
    axes[0].set_ylabel("Bandwidth (MB/s)", fontsize=19)
    axes[0].set_ylim(bottom=0)
    axes[0].set_yticks([10000, 20000, 30000, 40000])
    axes[0].yaxis.set_major_formatter(FuncFormatter(lambda x, _p: f"{int(x):,}"))
